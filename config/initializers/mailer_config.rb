  ...
  unless Rails.env == 'test' || !AppConfig.mail.enable?
    if AppConfig.mail.method == 'messagebus'
      ...
      if AppConfig.mail.message_bus_api_key.present?
        config.action_mailer.delivery_method = Messagebus::Mailer.new(AppConfig.mail.message_bus_api_key)
      ...
      sendmail_settings = {
        :location => AppConfig.mail.sendmail.location
      }
      ...
      smtp_settings = {
        ...
        :openssl_verify_mode => AppConfig.mail.smtp.openssl_verify_mode
      }
