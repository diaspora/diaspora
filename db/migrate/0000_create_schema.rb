class CreateSchema < ActiveRecord::Migration
  ...
  add_index 'aspect_memberships', %w(aspect_id contact_id), name: 'index_aspect_memberships_on_aspect_id_and_contact_id', unique: true
  ...
  add_index 'aspect_visibilities', %w(shareable_id shareable_type aspect_id), name: 'shareable_and_aspect_id'
  add_index 'aspect_visibilities', %w(shareable_id shareable_type), name: 'index_aspect_visibilities_on_shareable_id_and_shareable_type'
  ...
  add_index 'aspects', %w(user_id contacts_visible), name: 'index_aspects_on_user_id_and_contacts_visible'
  ...
  add_index 'comments', %w(commentable_id commentable_type), name: 'index_comments_on_commentable_id_and_commentable_type'
  ...
  add_index 'contacts', %w(user_id person_id), name: 'index_contacts_on_user_id_and_person_id', unique: true
  ...
  add_index 'conversation_visibilities', %w(conversation_id person_id), name: 'index_conversation_visibilities_usefully', unique: true
  ...
  add_index 'likes', %w(target_id author_id target_type), name: 'index_likes_on_target_id_and_author_id_and_target_type', unique: true
  ...
  add_index 'mentions', %w(person_id post_id), name: 'index_mentions_on_person_id_and_post_id', unique: true
  ...
  add_index 'notification_actors', %w(notification_id person_id), name: 'index_notification_actors_on_notification_id_and_person_id', unique: true
  ...
  add_index 'notifications', %w(target_type target_id), name: 'index_notifications_on_target_type_and_target_id'
  ...
  add_index 'participations', %w(target_id target_type author_id), name: 'index_participations_on_target_id_and_target_type_and_author_id'
  ...
  add_index 'posts', %w(author_id root_guid), name: 'index_posts_on_author_id_and_root_guid', unique: true
  add_index 'posts', ['author_id'], name: 'index_posts_on_person_id'
  add_index 'posts', ['guid'], name: 'index_posts_on_guid', unique: true
  add_index 'posts', %w(id type created_at), name: 'index_posts_on_id_and_type_and_created_at'
  add_index 'posts', ['root_guid'], name: 'index_posts_on_root_guid'
  add_index 'posts', %w(status_message_guid pending), name: 'index_posts_on_status_message_guid_and_pending'
  add_index 'posts', ['status_message_guid'], name: 'index_posts_on_status_message_guid'
  add_index 'posts', %w(type pending id), name: 'index_posts_on_type_and_pending_and_id'
  ...
  add_index 'profiles', %w(full_name searchable), name: 'index_profiles_on_full_name_and_searchable'
  ...
  add_index 'services', %w(type uid), name: 'index_services_on_type_and_uid'
  ...
  add_index 'share_visibilities', %w(shareable_id shareable_type contact_id), name: 'shareable_and_contact_id'
  add_index 'share_visibilities', %w(shareable_id shareable_type hidden contact_id), name: 'shareable_and_hidden_and_contact_id'
  ...
  add_index 'tag_followings', %w(tag_id user_id), name: 'index_tag_followings_on_tag_id_and_user_id', unique: true
  ...
  add_index 'taggings', %w(taggable_id taggable_type tag_id), name: 'index_taggings_uniquely', unique: true
  ...
  add_index 'users', %w(invitation_service invitation_identifier), name: 'index_users_on_invitation_service_and_invitation_identifier', unique: true
