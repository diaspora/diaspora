...
describe ProfilesController, type: :controller do
  ...
  describe '#show' do
    ...
    it 'returns a post Presenter' do
      ...
      get :show, id: 12_345, format: :json
  ...
  describe '#update' do
    ...
    it 'sets tags' do
      ...
      put :update, params
      expect(eve.person(true).profile.tag_list.to_set).to eq(%w(apples oranges).to_set)
    end
    ...
    it 'sets plaintext tags' do
      ...
      put :update, params
      expect(eve.person(true).profile.tag_list.to_set).to eq(%w(apples oranges pears).to_set)
    end
    ...
    it 'sets plaintext tags without #' do
      ...
      put :update, params
      expect(eve.person(true).profile.tag_list.to_set).to eq(%w(apples oranges bananas).to_set)
    end
