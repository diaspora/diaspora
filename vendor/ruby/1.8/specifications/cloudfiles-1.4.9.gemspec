...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "COPYING", "Manifest", "README.rdoc", "Rakefile", "TODO", "VERSION", "cloudfiles.gemspec", "lib/cloudfiles.rb", "lib/cloudfiles/authentication.rb", "lib/cloudfiles/connection.rb", "lib/cloudfiles/container.rb", "lib/cloudfiles/storage_object.rb", "test/cf-testunit.rb", "test/cloudfiles_authentication_test.rb", "test/cloudfiles_connection_test.rb", "test/cloudfiles_container_test.rb", "test/cloudfiles_storage_object_test.rb", "test/test_helper.rb"]
