...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-06-20}
  s.description = %q{    Daemons provides an easy way to wrap existing ruby scripts (for example a self-written server) 
  ...
  s.files = ["Rakefile", "Releases", "TODO", "README", "LICENSE", "setup.rb", "lib/daemons.rb", "lib/daemons/monitor.rb", "lib/daemons/application_group.rb", "lib/daemons/etc_extension.rb", "lib/daemons/daemonize.rb", "lib/daemons/cmdline.rb", "lib/daemons/controller.rb", "lib/daemons/change_privilege.rb", "lib/daemons/application.rb", "lib/daemons/pidmem.rb", "lib/daemons/pid.rb", "lib/daemons/pidfile.rb", "lib/daemons/exceptions.rb", "examples/call/call.rb", "examples/call/call_monitor.rb", "examples/run/ctrl_normal.rb", "examples/run/ctrl_monitor.rb", "examples/run/ctrl_proc.rb", "examples/run/ctrl_multiple.rb", "examples/run/ctrl_optionparser.rb", "examples/run/myserver.rb", "examples/run/myserver_hanging.rb", "examples/run/ctrl_exit.rb", "examples/run/myserver_crashing.rb", "examples/run/ctrl_proc_multiple.rb", "examples/run/ctrl_proc.rb.output", "examples/run/ctrl_keep_pid_files.rb", "examples/run/ctrl_proc_simple.rb", "examples/run/ctrl_ontop.rb", "examples/run/ctrl_crash.rb", "examples/run/ctrl_exec.rb", "examples/run/ctrl_hanging.rb", "examples/run/myserver_crashing.rb.output", "examples/run/ctrl_proc_multiple.rb.output", "examples/run/myserver_exiting.rb", "examples/daemonize/daemonize.rb"]
